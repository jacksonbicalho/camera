...
const settings = {
  ...
  server: { port: 8080, segments_path: '/data/segments', recordings_path: '/data/recordings', username: 'admin' },
  storage: { path: '/data', with_motion_minutes: 0, without_motion_minutes: 0, interval_minutes: 0, max_size_gb: 0, warn_percent: 0 },
