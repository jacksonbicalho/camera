...
const MIGRATED_FILES = [
  ...
  'src/components/ListPanel.tsx',
  'src/components/Player.tsx',
  'src/components/RecordingTimeline.tsx',
...
describe('padding de cards — convergência para p-4 (dense) / p-5 (form)', () => {
  ...
  it('StatsPage/StorageSettingsPage não usam mais o outlier p-6', () => {
    ...
    expect(stats).not.toMatch(/\bp-6\b/)
    expect(storage).not.toMatch(/\bp-6\b/)
  })
