...
// cada bolinha já mostra a própria cor via `data-accent` escopado (mesmo truque
// do AccentSwatchGroup em AppearanceSettingsPage: `var(--color-primary)` resolve
// pro accent daquele elemento, sem afetar o resto da página).
