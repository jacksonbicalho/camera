...
describe('PlayerControlsOverlay', () => {
  it('sem zoom ativo, não mostra nenhum botão (tela cheia mudou para o rodapé do player)', () => {
  ...
  it('com zoom ativo, mostra o botão de reset com a escala atual', () => {
    render(<PlayerControlsOverlay id="p1" zoom={makeZoom({ isZoomed: true, scale: 2.5 })} />)
  ...
  it('clicar no botão de reset chama zoom.reset', () => {
    const reset = vi.fn()
    render(<PlayerControlsOverlay id="p1" zoom={makeZoom({ isZoomed: true, reset })} />)
