...
// cheia), extraído do Player.tsx (ao vivo) para ser reaproveitado também pelo player
// de Histórico. Só aparece no hover do container (`group`) ou com foco dentro dele.
