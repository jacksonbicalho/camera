        ...
        <div className="sm:col-span-2">
          ...
          <div className="flex gap-2">
            ...
            >
              ...
              <option value="webrtc">
                WebRTC — baixa latência{liveRecommended === 'webrtc' ? ' (recomendado)' : ''}
              </option>
              <option value="hls">
        ...
        {showAdvanced && (
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mt-3">
            ...
            <div>
              ...
              <p className="text-xs text-muted-foreground mt-0.5">
                Cada segmento de vídeo ao vivo tem essa duração. Valores menores reduzem a latência,
                mas aumentam o processamento.
              </p>
            </div>
