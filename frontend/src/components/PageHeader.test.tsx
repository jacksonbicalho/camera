...
describe('PageHeader', () => {
  it('CA2: título renderiza como <h2> com o token text-h2 do design system (padrão único)', () => {
  ...
  it('CA3: subtítulo renderiza como <h3> com o token text-h3 do design system', () => {
